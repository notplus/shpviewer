...
QT_MOC_LITERAL(1, 12, 11), // "updateScale"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "i"
QT_MOC_LITERAL(4, 27, 12) // "updateRotate"

    },
    "paintWidget\0updateScale\0\0i\0updateRotate"
};
...
void paintWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateScale((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateScale(); break;
        case 2: _t->updateRotate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->updateRotate(); break;
        default: ;
        }
    }
}
